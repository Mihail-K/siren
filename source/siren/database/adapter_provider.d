...
public:
    ...
    /++
     ...
     ++/
    static Token register(A : Adapter)(string name)
    {
        enum typename = fullyQualifiedName!A;
        return register(name, ClassInfo.find(typename));
    }

    private static Token register()(string name, ClassInfo class_)
    {
